...
const SignIn = () => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      router.push("./ChatInterface");  //it will direct to chat Interface after Successful login
    } catch (error) {
  ...
  return (
    <Box sx={{
      backgroundImage: 'url(/image.jpg)', // Set page background to bg.png image
      ...
      <Card sx={{
        ...
        <Box sx={{ color: '#121212' }}>
          <FormControl sx={{ width: '100%' }}>
            ...
            {/*///////// Error Display /////////*/}
            <Box sx={{ minHeight: '24px', textAlign: 'center' }}>
              {error && (
